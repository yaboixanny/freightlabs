...
<main>
<header class="ads-hero"><div class="container ads-hero-grid"><div class="ads-hero-content"><div class="hero-eyebrow"><span></span>{escape(d["eyebrow"])}</div><h1>{escape(d["h1"])}</h1><p class="ads-hero-lead">{escape(d["lead"])}</p><div class="btn-group"><a href="https://cal.com/alexanderstefanseo/freight-labs-discovery-call" class="btn-primary">See how we can help <span aria-hidden="true">↗</span></a><a href="#strategy" class="hero-text-link">See how it works <span aria-hidden="true">↓</span></a></div><div class="ads-hero-meta">{tag_spans}</div></div><div class="ads-dashboard-wrap"><div class="ads-dashboard-frame"><img src="../freight_ads_dashboard.png" alt="Marketing performance dashboard"><div class="ads-dashboard-tag"><span>What we focus on</span><strong>Better leads</strong></div></div><div class="ads-result-chip"><strong>B2B</strong><span>logistics growth</span></div></div></div></header>
